...
//   return (
//     <div className='my-8 w-full max-w-sum mx-auto'>
...
function Post({ post }) {
  ...
  return (
    <div className="my-10 w-full max-w-md mx-auto bg-white border border-gray-200 rounded-md shadow-sm">
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-3">
            <h1 className='font-semibold text-sm'><Link to={`/profile/${post.author._id}`}>{post.author?.username}</Link></h1>
      ...
      <div className="px-4 py-3 border-t border-gray-100 flex items-center justify-between">
        ...
        {text && (
          <span
            ...
            className="text-[#3BADF8] cursor-pointer text-sm font-medium ml-2"
          >
            Post
          </span>
        )}
